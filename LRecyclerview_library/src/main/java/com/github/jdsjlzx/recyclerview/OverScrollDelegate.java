...
import com.github.jdsjlzx.recyclerview.PathScroller.PathPointsHolder;

public class OverScrollDelegate {
	public static String TAG = OverScrollDelegate.class.getSimpleName();
	...
	public static abstract class OverScrollStyle {
		...
		public void drawOverScrollTop(float offsetY, Canvas canvas, View view) {
			Log.d(TAG,"drawOverScrollTop===+offsetY=="+offsetY);
		};
		...
		public void drawOverScrollBottom(float offsetY, Canvas canvas, View view) {
			Log.d(TAG,"drawOverScrollBottom===+offsetY=="+offsetY);
		};
...
//			}
	...
	public void onAbsorb(final int velocityY) {
