...
import com.github.jdsjlzx.recyclerview.OverScrollDelegate;
 ...
 *
 */
public class LRecyclerView extends RecyclerView implements OverScrollDelegate.OverScrollable {
    ...
    public void draw(Canvas canvas) {
        if(testFlag){
            mOverScrollDelegate.draw(canvas,testFlag);
        }else{
